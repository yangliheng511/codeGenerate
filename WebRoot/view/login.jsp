...
#login .logo {
 ...
 <body>
       ...
       <div style="float: right; padding: 3px 0; margin-right: -12px;">
        <div>
         <ul class="uibutton-group">
          <li>
           <a class="uibutton normal" href="javascrpt:void(0);" id="but_login">登陆</a>
          </li>
          <li>
  ...
  <div id="versionBar">
   <div class="copyright">
    &copy; 版权所有
    <span class="tip"><a href="http://www.jeecg.org" title="JEECG-Mybatis 演示系统">jeecg</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="javascrpt:void(0);" title="JEECG-Mybatis 演示系统">jeecg</a></span>
   </div>
  </div>
  <!-- Link JScript-->
