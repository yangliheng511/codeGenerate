...
{
  private static final ResourceBundle bundle = ResourceBundle.getBundle("common/database");
  private static final ResourceBundle bundlePath = ResourceBundle.getBundle("common/config");
